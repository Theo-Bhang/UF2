...
def createdb():
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            # SQL 
            sql = 'Insert into defis_du_jour (titre , description,valeur ,date_publication,date_fin ) values ("'+afficheTitre+'","'+afficheDesc+'","'+afficheval+'",DATE(NOW()),DATE(NOW())) '
...
def supUser():
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            # SQL 
            sql = 'DELETE from defis_du_jour where defisID  ="'+afficheId+'"'
...
def updateDb():
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            # SQL 
            sql = 'update  defis_du_jour (titre , description ,valeur, date_publication, date_fin) values ("'+afficheTitre+'","'+afficheDesc+'",',afficheval,',DATE(NOW()),DATE(NOW())) '
            print(sql)
            # Exécutez la requête (Execute Query).
            cursor.execute(sql)
            connection.commit()
...
def readupDb1() :
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            # SQL 
            sqlr = 'select titre,description,valeur,date_publication,date_fin From defis_du_jour where defisID  = "'+infoDefi+'"'
...
def readupDb2() :
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            # SQL 
            sqlu = 'update defis_du_jour set '+radiochange +' = "'+changeval+'" where defisID  = "'+infodefi+'" '
            print(sqlu)
            # Exécutez la requête (Execute Query).
            cursor.execute(sqlu)
            connection.commit()
...
def Creer() :
    ...
    valeur=Entry(window, text="Saisissez la valeur du defis_du_jour", bd=5)
...
def Modifier2() :
    ...
    btn.place(x=60, y=300)
    window.title('Infos defis_du_jour')
    window.geometry("500x400+10+10")
    window.mainloop()
